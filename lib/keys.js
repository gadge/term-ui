...
const { DATA, KEYPRESS, NEW_LISTENER } = require('@pres/enum-events'),
...
function emitKeypressEvents(stream) {
  ...
  const { StringDecoder } = require('string_decoder')  // lazy load
  ...
  function onData(b) {
    ...
    else { stream.removeListener(DATA, onData), stream.on(NEW_LISTENER, onNewListener) }   // Nobody's watching anyway
  }
