...
const {
        BLUR, CLICK, DESTROY, ERROR, EXIT,
        FOCUS, KEY, KEYPRESS, MOUSE, MOUSEDOWN, MOUSEMOVE, MOUSEOUT, MOUSEOVER, MOUSEUP,
        MOUSEWHEEL, NEW_LISTENER, PRERENDER, RENDER, RESIZE, UNCAUGHT_EXCEPTION, WARNING, WHEELDOWN, WHEELUP
      }                            = require('@pres/enum-events'),
      { SIGTERM, SIGINT, SIGQUIT } = require('@geia/enum-signals'),
