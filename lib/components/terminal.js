...
const {
        BLUR, DATA, DESTROY, EXIT,
        FOCUS, KEYPRESS, MOUSE, MOUSEDOWN, PASSTHROUGH, RENDER, RESIZE, SCROLL, TITLE
...
Terminal.prototype.bootstrap = function () {
  ...
  this.screen.program.input.on(DATA, this._onData = data => {
...
Terminal.prototype._isMouse = buf => {
  let s = buf
